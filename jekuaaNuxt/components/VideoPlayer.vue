<template>
  <div class="contenedorVideo">
    <video ref="videoPlayer" class="video-js vjs-theme-forest vjs-16-9 customStyleVideo" />
  </div>
</template>
