                        ...
                        <div slot-scope="{ items }">
                          <div v-for="(item, index) in items" :key="index" class="card-link mb-5">
                            <article class="blog-card">
                              ...
                              <!-- Parte: Imagen Curso -->
                              <nuxt-link :to="`/moderador/curso-borrador/${item.objectID}`">
                                <img 
                              ...
                              <div class="article-details">
                                ...
                                <div class="my-4">
                                  ...
                                  >
                                    ...
                                    {{ getDescuento(item.datosPrecio.precio, item.datosPrecio.descuento) }}
                                  </v-chip>
...
export default {
    ...
    methods: {
      ...
      getDescuento (precio, descuento) {
        ...
        if ( descuentoNumero.toString().includes('.') && descuentoNumero.toString().length > 4 ) 
          return descuentoNumero.toString().substr(0, 4)
