                          ...
                          <div v-for="item in items" :key="item.objectID" class="card-link mb-5">
                            <article class="blog-card">
                              ...
                              <div class="article-details">
                                ...
                                <p class="post-author">
                                  {{ $store.state.modules.usuarios.nombreCompleto }}
                                  <b>{{ getFuncionCursoDeUsuario(item) }}</b>
                                </p>
...
export default {
    data() {
        return {
            ...
            indexName: process.env.NODE_ENV === 'production' ? 'prod_cursos_borrador' : 'dev_cursos_borrador',
            filtros: '',
            drawerFilter: false,
