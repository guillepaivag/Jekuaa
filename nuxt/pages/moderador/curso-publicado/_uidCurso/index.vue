...
export default {
    ...
    data() {
        return {
            ...
            items: [
                { id: 'estudiantes', title: 'Actualizar estudiantes', description: 'Agregar/eliminar estudiantes en este curso.', to: `/moderador/curso-publicado/${this.$route.params.uidCurso}/estudiantes` },
