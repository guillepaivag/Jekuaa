...
// CONCATENATED MODULE: ./node_modules/vuetify-loader/lib/loader.js??ref--4!./node_modules/babel-loader/lib??ref--2-0!./node_modules/vue-loader/lib/loaders/templateLoader.js??ref--7!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/moderador/curso-borrador/_uidCurso/auxiliares.vue?vue&type=template&id=1e681e7c&scoped=true&
...
var auxiliaresvue_type_template_id_1e681e7c_scoped_true_render = function render() {
  var _vm = this,
      _c = _vm._self._c;
  ...
  return _c('div', {
    ...
    staticClass: "mt-3"
  }, [_vm.tipoBusquedaCorreo ? _c(VTextField["a" /* default */], {
    attrs: {
      "counter": 100,
    ...
    staticClass: "my-7"
  }), _vm._v(" "), _vm.buscando ? _c('div', [_vm._v("\n                Buscando..\n                "), _c(VProgressLinear["a" /* default */], {
    attrs: {
      "indeterminate": "",
      "color": "#683bce"
    }
  })], 1) : _c('div', [_vm.datosUsuario ? _c('div', {}, [_vm.datosCurso.instructor !== _vm.datosUsuario.firestore.uid && _vm.datosUsuario.miembro.funciones.includes('instructor-auxiliar') ? _c('div', {
    staticClass: "text-center"
  }, [_vm.uidAuxiliares.includes(_vm.datosUsuario.firestore.uid) ? _c('div', {
    staticClass: "mb-7"
  }, [_c(VBtn["a" /* default */], {
    attrs: {
      "disabled": _vm.actualizandoAuxiliares,
      "outlined": "",
      "rounded": "",
      "text": "",
      "color": "#683bce"
    ...
    on: {
      "click": function ($event) {
        return _vm.quitarAuxiliar(_vm.datosUsuario.firestore.uid);
      }
    }
  }, [_c(VIcon["a" /* default */], {
    attrs: {
    ...
    on: {
      "click": function ($event) {
        return _vm.agregarAuxiliar(_vm.datosUsuario.firestore.uid);
      }
    }
  }, [_c(VIcon["a" /* default */], {
    attrs: {
  ...
  }, [_vm._v("\n                                    mdi-plus\n                                ")]), _vm._v("\n                                Agregar auxiliar\n                            ")], 1)], 1)]) : _vm._e(), _vm._v(" "), _c('VisualizadorDatosUsuario', {
    attrs: {
      "firestore": _vm.datosUsuario.firestore,
      "auth": _vm.datosUsuario.auth,
      "miembro": _vm.datosUsuario.miembro
    }
  })], 1) : _vm.noExisteElUsuario ? _c('div', [_vm._v("\n                    No existe el usuario :(\n                ")]) : _c('div', [_vm._v("\n                    Busca un usuario :)\n                ")])])], 1), _vm._v(" "), _c(VCol["a" /* default */], {
    attrs: {
      "cols": "12",
      "md": "4"
    }
  }, _vm._l(_vm.datosAuxiliares, function (item, index) {
    return _c(VCard["a" /* default */], {
    ...
    }, [_c(VList["a" /* VListItemContent */], [item.estado === 'cargando' ? _c(VList["c" /* VListItemTitle */], {
      staticClass: "text-h5 mb-1"
    }, [_vm._v("\n                            Cargando...\n                        ")]) : _c(VList["c" /* VListItemTitle */], {
      staticClass: "text-h5 mb-1"
    }, [_vm._v("\n                            " + _vm._s(item.auth.displayName) + "\n                        ")]), _vm._v(" "), item.estado !== 'cargando' ? _c(VList["b" /* VListItemSubtitle */], [_vm._v("\n                            " + _vm._s(item.firestore.nombreUsuario) + "\n                        ")]) : _vm._e()], 1), _vm._v(" "), item.estado === 'cargando' ? _c(VListItemAvatar["a" /* default */], {
      attrs: {
        "tile": "",
        "size": "80",
        "color": "grey"
      ...
      attrs: {
        "src": item.auth.photoURL
      }
    })], 1)], 1), _vm._v(" "), _c(components_VCard["a" /* VCardActions */], [_c('div', {
      staticClass: "py-2"
    }, [_c(VBtn["a" /* default */], {
      attrs: {
        "disabled": _vm.actualizandoAuxiliares || item.estado === 'cargando',
        "outlined": "",
        "rounded": "",
        "text": "",
        "color": "#683bce"
      ...
      on: {
        "click": function ($event) {
          return _vm.quitarAuxiliar(item.uid);
        }
      }
    }, [_c(VIcon["a" /* default */], {
      attrs: {
...
// CONCATENATED MODULE: ./pages/moderador/curso-borrador/_uidCurso/auxiliares.vue?vue&type=template&id=1e681e7c&scoped=true&
...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/moderador/curso-borrador/_uidCurso/auxiliares.vue?vue&type=script&lang=js&
    ...
    async buscar() {
      try {
        ...
        if (data.resultado.firestore.rol !== 'estudiante') {
          const doc = await db.collection('Miembros').doc(data.resultado.firestore.uid).get();
  ...
  async created() {
    ...
    const myPromise = new Promise((res, rej) => {
      for (let i = 0; i < this.uidAuxiliares.length; i++) {
        ...
        db.collection('Usuarios').doc(uidAuxiliar).get().then(async docUsuario => {
          const {
            resultado
          } = await this.$axios.$get(`/serviceUsuario/obtenerAuthentication/uid/${docUsuario.id}`);
          aux[i] = {
            uid: uidAuxiliar,
    ...
    myPromise.then(res => {
      this.datosAuxiliares = res;
    });
  }

});
// CONCATENATED MODULE: ./pages/moderador/curso-borrador/_uidCurso/auxiliares.vue?vue&type=script&lang=js&
 /* harmony default export */ var _uidCurso_auxiliaresvue_type_script_lang_js_ = (auxiliaresvue_type_script_lang_js_); 
// EXTERNAL MODULE: ./node_modules/vue-loader/lib/runtime/componentNormalizer.js
var componentNormalizer = __webpack_require__(7);

// CONCATENATED MODULE: ./pages/moderador/curso-borrador/_uidCurso/auxiliares.vue
...
var component = Object(componentNormalizer["a" /* default */])(
  ...
  auxiliaresvue_type_template_id_1e681e7c_scoped_true_render,
  staticRenderFns,
  false,
  injectStyles,
  "1e681e7c",
