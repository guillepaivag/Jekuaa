const informacionCodigos = require("../utils/InformacionCodigo")
...
class Respuesta {
    ...
    */
    ...
    setRespuestaPorCodigo ( codigo, opciones ) {
        ...
        let informacionCodigo = informacionCodigos [ rutasCodigo[0] ]

        if ( rutasCodigo[0] === 'error' ) {
            informacionCodigo = informacionCodigo [ rutasCodigo[1] ]
        }
